...
/*   Updated: 2023/04/13 11:04:28 by mkiflema         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	close_so_long(t_data data, char ***holder)
{
...
void	check_input_validity(char **argv, char *storage, int fd)
{
	if (!argv[1] || !argv[1][0] || !is_name_valid(argv[1]))
		display_message(0);
...
int	main(int argc, char **argv)
{
	...
	if (argc == 2)
	{
		check_input_validity(argv, storage, fd);
